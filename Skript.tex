...
(a) Die Kette \(Ker(\phi) \subseteq Ker(\phi^2) c_ Ker(\phi^3) c_ ...\) von \(K\)-Untervektorräumen von \(V\) wird stationär. Der Untervektorraum \(BigKer(\phi)=Ker(\phi^i)\) mit \(i >> 0\) heißt der \(\ul{große Kern}\) von \(\phi\).
